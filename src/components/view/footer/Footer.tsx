  ...
  return (
    <footer className="bg-zinc-900 px-8 py-12 mx-2 my-2 rounded-2xl text-white">
          ...
          <div className="flex flex-col space-y-2">
            <div className="flex space-x-4 text-white">
              <Link
                ...
                target="_blank"
                className="github hover:text-blue-500"
              >
                <svg
              ...
              <Link
                ...
                target="_blank"
                className="linkedin hover:text-pink-500"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  x="0px"
              ...
              <Link
                ...
                target="_blank"
                className="instagram hover:text-sky-400"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  x="0px"
      ...
      <div className="border-t border-gray-700 mt-8 pt-4 text-center text-gray-500 text-sm">
        &copy; {new Date().getFullYear()} Cerita.in. All rights reserved.
        Develop by Anam Sadat
      </div>
    </footer>
  );
}
